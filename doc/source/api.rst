...
`DQuality <https://github.com/bfrosik/data-quality>`_ provides the following funtionalities:
    ...
    - "*File*": verify the correctness of the data and meta-data structure in an hdf5 file.

    - "*Dependencies*": verify dependencies between the data and meta-data structure in an hdf5 file.
    ...
    - "*Data_Monitor*": monitor the active data collection directory and run "*Data*" on each new file.
    ...
    - "*Check*": `DQuality <https://github.com/bfrosik/data-quality>`_ provide a wrapper to "*PV*", "*File*", "*Dependencies*", "*Data*" and "*Monitor*".
